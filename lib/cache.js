...
module.exports = class Cache {
  ...
  async refreshCache() {
    ...
    console.log(data,"data--refreshCache")
    ...
    console.log("data_lenth_present")
    ...
    console.log("release present",release);
    ...
    console.log("release present chlgeya");


    const { tag_name } = release

    console.log("tag_name",tag_name);
    console.log("this.latest.version",this.latest.version)
    ...
    console.log("this.latest.platforms",this.latest.platforms)
  ...
  async loadCache() {
    ...
    console.log(latest,isOutdated(),"latest")
